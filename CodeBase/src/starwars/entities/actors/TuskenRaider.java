...
public class TuskenRaider extends SWActor {
	...
	public TuskenRaider(int hitpoints, String name, MessageRenderer m, SWWorld world) {
		super(Team.TUSKEN, 50, m, world, 0);
	...
	public void act() {
		...
		AttackInformation attack = AttackNeighbours.attackLocals(this, this.getWorld(), false, false);
		if (attack != null) {
			...
			Move myMove = new Move(heading, messageRenderer, getWorld());
