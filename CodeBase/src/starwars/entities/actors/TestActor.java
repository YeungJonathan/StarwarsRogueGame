...
public class TestActor extends SWActor {
	 ...
	 */
	public void act() {
		say(this.getShortDescription() + " is standing still at " + this.getWorld().getEntityManager().whereIs(this).getShortDescription());
		describeScene();
	}
	...
	public void describeScene() {
		...
		SWLocation location = this.getWorld().getEntityManager().whereIs(this);
		...
		List<SWEntityInterface> contents = this.getWorld().getEntityManager().contents(location);
