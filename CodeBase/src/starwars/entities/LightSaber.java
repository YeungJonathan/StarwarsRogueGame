 ...
 * 
 *  @author Robert
 *  @author Ariffin updated for forceRequirement implementation
 *  @see {@link starwars.actions.Attack}
 */

public class LightSaber extends SWEntity {
	
	private static final int forceRequirement = 30;
	...
	/**
	 * method to return the <code>forceRequirement</code> attribute
	 * @author Ariffin
	 * @return forceRequirement
	 */
	public static int getForceRequirement() {
		return forceRequirement;
	}
