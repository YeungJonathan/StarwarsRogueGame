...
public class SWWorld extends World {
	 ...
	 * and the grid.
	 * parameters: x is the width of the grid, y is the height of the grid
	 * author: Jonathan Yeung
	 */
	public SWWorld(int x, int y) {
		SWLocation.SWLocationMaker factory = SWLocation.getMaker();
		myGrid = new SWGrid(x,y,factory);
		space = myGrid;
	...
	/**
	 * setting descriptions for different worlds
	 * @param worldName	name of the world
	 * 
	 * @author Jonathan Yeung
	 */
	protected void setLocationString(String worldName) {
		SWLocation loc;
	...
	public void initializeWorld(MessageRenderer iface) {
		...
		this.setLocationString("SWWorld");	
		...
		//SandCrawler
		Sandcrawler sc = new Sandcrawler(iface, this, patrolmoves);
		sc.setSymbol("S");
		...
		// A Droid
		Droid r2d2 = new Droid(10, "R2D2", iface, this, luke);
		r2d2.setSymbol("R");
