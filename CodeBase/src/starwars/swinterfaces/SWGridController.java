...
public class SWGridController implements GridController {
	 ...
	 * @param call: added parameter to indicate if banner is showing or not
	 * @pre 	the world should not be null
	 */
	// added paramter call to indicate if wants to show banner or not
	public SWGridController(SWWorld world, boolean call) {
		this.grid = world.getGrid();
		
		//change the user interface to be used here in the constructor
		SWGridController.ui = new SWGridTextInterface(this.grid, call); //use a Text Interface to interact
